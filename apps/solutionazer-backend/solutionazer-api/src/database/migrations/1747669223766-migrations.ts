...
export class Migrations1747669223766 implements MigrationInterface {
    name = 'Migrations1747669223766'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "website_config" ADD "url" text NOT NULL DEFAULT 'https://staging.solutionazer.app'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "website_config" DROP COLUMN "url"`);
    }
