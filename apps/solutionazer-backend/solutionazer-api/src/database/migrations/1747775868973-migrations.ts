...
export class Migrations1747775868973 implements MigrationInterface {
    name = 'Migrations1747775868973'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "question_response" ADD "dateValue" date`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "question_response" DROP COLUMN "dateValue"`);
    }
