...
export class Migrations1747766520330 implements MigrationInterface {
    name = 'Migrations1747766520330'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "question_response" ADD "sessionUuid" uuid NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "question_response" DROP COLUMN "sessionUuid"`);
    }
