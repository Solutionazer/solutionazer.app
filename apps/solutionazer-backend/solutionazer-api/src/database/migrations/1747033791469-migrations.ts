...
export class Migrations1747033791469 implements MigrationInterface {
    name = 'Migrations1747033791469'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "data_collector" ADD "isPublished" boolean NOT NULL DEFAULT false`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "data_collector" DROP COLUMN "isPublished"`);
    }
